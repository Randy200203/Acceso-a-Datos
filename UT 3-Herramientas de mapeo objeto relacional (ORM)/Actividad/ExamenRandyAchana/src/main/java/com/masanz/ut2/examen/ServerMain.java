...
public class ServerMain {
    ...
    private static EmpresasDTO empresaLogeada = null;
    ...
    public static void main(String[] args) {
        ...
        get("/formulario-edicion-empresa/:id", (request, response) -> {
            ...
            EmpresasDTO empresaEditar = tareas.obtenerEmpresa(id);
            Map<String, Object> model = new HashMap<>();
        ...
        get("/formulario-edicion-producto/:id", (request, response) -> {
            int id = Integer.parseInt(request.params(":id"));
            ProductosDTO productoEditar = tareas.obtenerProducto(id);
            Map<String, Object> model = new HashMap<>();
